...
const MobileNav: React.FC<MobileNavProps> = ({ onHomeClick }) => {
    return (
        <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-gray-900/80 backdrop-blur-sm border-t border-gray-700 z-50">
